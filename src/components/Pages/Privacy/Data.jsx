  ...
  return (
    <div style={{ fontSize: "20px", marginRight: "25px", marginLeft: "25px" }}>
      ...
      <Grow in="false" timeout={2000}>
        <div className="data">
          <p style={{ textAlign: "center" }}>Effective date: 2022-10-05</p>
          <p
            style={{
              marginTop: "20px",
              marginBottom: "20px",
          ...
          <p>
            Welcome to <b> BolStats</b>.
          </p>
          <p>
            <b>BolStats</b> (“us”, “we”, or “our”) operates <b>bolstats.com</b>{" "}
            (hereinafter referred to as <b>“Service”</b>).
          </p>
          <p>
            Our Privacy Policy governs your visit to <b>bolstats.com</b>, and
          ...
          <p>
            <b>SERVICE</b> means the bolstats.com website operated by BolStats.
          </p>
          <p>
          ...
          <p>BolStats uses the collected data for various purposes:</p>
          ...
          <p>
            ...
            Personal Data, to Netherlands and process it there.
          </p>
          <p>
          ...
          <p>
            BolStats will take all the steps reasonably necessary to ensure that
          ...
          <p>
            ...
            method of transmission over the Inte rnet or method of electronic
          ...
          <p>
            ...
            please send your request(s) by email: <b>bolstats@gmail.com</b>.
          </p>
          <p>
          ...
          <p>
            ...
            us by email: <b>bolstats@gmail.com</b>.
          </p>
          <p style={{ marginTop: "5em", fontSize: "0.7em" }}>
            This was created for <b>bolstats.com</b> by on 2022-10-05.
          </p>
        </div>
      </Grow>
    </div>
